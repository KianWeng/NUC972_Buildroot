...
#
################################################################################
ROOTFS_SOURCE_DIR = $(strip $(BR2_TARGET_ROOTFS_JFFS2_SOURCE_DIR))
...
define ROOTFS_JFFS2_CMD
	$(MKFS_JFFS2) $(JFFS2_OPTS) -d $(ROOTFS_SOUECE_DIR) -o $@.nosummary
	$(SUMTOOL) $(SUMTOOL_OPTS) -i $@.nosummary -o $@
	rm $@.nosummary
endef
else
define ROOTFS_JFFS2_CMD
	$(MKFS_JFFS2) $(JFFS2_OPTS) -d $(ROOTFS_SOURCE_DIR) -o $@
endef
endif
